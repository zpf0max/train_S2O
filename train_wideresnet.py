...
def getNetwork(args):
    if (args.net_type == 'lenet'):
        ...
        predict_model = torch.load('/home/zhaopf/S2O-main/CIFAR10_TRADES_S2O/checkpoint/cifar10/resnet50-19c8e357.pth')
        ...
        '''
        net = ResNet(args.depth, num_classes)
        #pretrain_weights_path = "/home/zhaopf/S2O-main/CIFAR10_TRADES_S2O/checkpoint/cifar10/resnet50-19c8e357.pth"
        '''
        ...
        '''
        file_name = 'resnet-'+str(args.depth)+"origin-normalize"
        #file_name = "/home/zhaopf/S2O-main/CIFAR10_TRADES_S2O/model-cifar10-wideresnet/result_adv_train/resnet50_uncrop.pt"
