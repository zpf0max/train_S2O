...
parser.add_argument('--model-dir', default='./model-cifar10-wideresnet/wide_resnet',
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # adversarial training
            ...
            fisher=fisher_matrix_diag(data0,target0,model,criterion,sbatch=200,epoch=epoch-base)
